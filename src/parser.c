...
enum {
  ...
  sym_number = 26,
  sym_camelIdentifier = 27,
  sym_pascalIdentifier = 28,
  sym_decoratorIdentifier = 29,
  sym_macroIdentifier = 30,
  sym_program = 31,
  sym_Block = 32,
  sym_Property = 33,
  sym_Decorator = 34,
  ...
  aux_sym_GenericArgs_repeat1 = 55,
...
static const char *ts_symbol_names[] = {
  ...
  [sym_ExtendsArgs] = "ExtendsArgs",
  [sym_DecoratorArgs] = "DecoratorArgs",
  [sym_Body] = "Body",
  [sym_BodyElement] = "BodyElement",
  [sym_PropertyType] = "PropertyType",
  [sym_atom] = "atom",
  [sym_bexp] = "bexp",
  [sym_disj] = "disj",
  [sym_conj] = "conj",
...
static TSSymbol ts_symbol_map[] = {
  ...
  [sym_ExtendsArgs] = sym_ExtendsArgs,
  [sym_DecoratorArgs] = sym_DecoratorArgs,
  [sym_Body] = sym_Body,
  [sym_BodyElement] = sym_BodyElement,
  [sym_PropertyType] = sym_PropertyType,
  [sym_atom] = sym_atom,
  [sym_bexp] = sym_bexp,
  [sym_disj] = sym_disj,
  [sym_conj] = sym_conj,
  [sym_comp] = sym_comp,
  [sym_neg] = sym_neg,
  [sym_bvalue] = sym_bvalue,
  [sym_aexp] = sym_aexp,
  [sym_addsub] = sym_addsub,
  [sym_muldiv] = sym_muldiv,
  [sym_avalue] = sym_avalue,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 83:
      ...
      END_STATE();
    case 84:
      ACCEPT_TOKEN(sym_macroIdentifier);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(84);
...
static uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_camelIdentifier] = ACTIONS(5),
    [sym_decoratorIdentifier] = ACTIONS(7),
  },
};
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [23] = {.count = 1, .reusable = false}, REDUCE(sym_avalue, 3),
  [25] = {.count = 1, .reusable = true}, REDUCE(sym_avalue, 3),
  ...
  [35] = {.count = 1, .reusable = false}, REDUCE(sym_muldiv, 1),
  [37] = {.count = 1, .reusable = true}, REDUCE(sym_muldiv, 1),
  [39] = {.count = 1, .reusable = false}, REDUCE(sym_addsub, 1),
  [41] = {.count = 1, .reusable = true}, REDUCE(sym_addsub, 1),
  [43] = {.count = 1, .reusable = true}, SHIFT(25),
  [45] = {.count = 1, .reusable = false}, REDUCE(sym_muldiv, 3),
  [47] = {.count = 1, .reusable = true}, REDUCE(sym_muldiv, 3),
  [49] = {.count = 1, .reusable = false}, REDUCE(sym_addsub, 3),
  [51] = {.count = 1, .reusable = true}, REDUCE(sym_addsub, 3),
  [53] = {.count = 1, .reusable = false}, REDUCE(sym_atom, 1),
  [55] = {.count = 1, .reusable = true}, REDUCE(sym_atom, 1),
  [57] = {.count = 1, .reusable = false}, REDUCE(sym_avalue, 1),
  [59] = {.count = 1, .reusable = true}, REDUCE(sym_avalue, 1),
  [61] = {.count = 1, .reusable = false}, REDUCE(sym_aexp, 1),
  [63] = {.count = 1, .reusable = true}, REDUCE(sym_aexp, 1),
  [65] = {.count = 1, .reusable = true}, SHIFT(26),
  [67] = {.count = 1, .reusable = true}, SHIFT(23),
  [69] = {.count = 1, .reusable = false}, SHIFT(24),
  [71] = {.count = 1, .reusable = true}, REDUCE(sym_bvalue, 1),
  ...
  [89] = {.count = 1, .reusable = false}, REDUCE(sym_bvalue, 1),
  ...
  [113] = {.count = 1, .reusable = true}, REDUCE(sym_comp, 3),
  [115] = {.count = 1, .reusable = true}, REDUCE(sym_bvalue, 3),
  [117] = {.count = 1, .reusable = true}, REDUCE(sym_conj, 1),
  [119] = {.count = 1, .reusable = true}, REDUCE(sym_GenericArgs, 3),
  [121] = {.count = 1, .reusable = true}, REDUCE(sym_Property, 5),
  [123] = {.count = 1, .reusable = true}, REDUCE(sym_PropertyType, 1),
  [125] = {.count = 1, .reusable = true}, REDUCE(sym_GenericArgs, 4),
  [127] = {.count = 1, .reusable = true}, REDUCE(sym_conj, 3),
  [129] = {.count = 1, .reusable = true}, REDUCE(sym_neg, 2),
  [131] = {.count = 1, .reusable = true}, REDUCE(sym_neg, 1),
  [133] = {.count = 1, .reusable = true}, REDUCE(sym_comp, 1),
  [135] = {.count = 1, .reusable = true}, REDUCE(sym_disj, 3),
  ...
  [145] = {.count = 1, .reusable = true}, REDUCE(sym_disj, 1),
  ...
  [206] = {.count = 1, .reusable = true}, REDUCE(aux_sym_GenericArgs_repeat1, 2),
  [208] = {.count = 1, .reusable = true}, REDUCE(sym_bexp, 1),
  [210] = {.count = 1, .reusable = true}, SHIFT(9),
  [212] = {.count = 2, .reusable = true}, REDUCE(aux_sym_GenericArgs_repeat1, 2), SHIFT_REPEAT(4),
  ...
  [231] = {.count = 2, .reusable = true}, REDUCE(aux_sym_GenericArgs_repeat1, 2), SHIFT_REPEAT(3),
  [234] = {.count = 1, .reusable = true}, REDUCE(sym_Property, 6),
  [236] = {.count = 1, .reusable = true}, SHIFT(45),
  [238] = {.count = 1, .reusable = true}, SHIFT(100),
  [240] = {.count = 1, .reusable = true}, REDUCE(sym_DecoratorArgs, 3),
  ...
  [252] = {.count = 1, .reusable = true}, REDUCE(sym_DecoratorArgs, 4),
  [254] = {.count = 1, .reusable = true}, REDUCE(sym_ExtendsArgs, 3),
  [256] = {.count = 1, .reusable = true}, REDUCE(sym_ExtendsArgs, 4),
